    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">{l s='Change my next payment date' mod='ciklik'}</h5>
            ...
            <div class="modal-body">
                ...
                <form id="newDateForm-{$subscription->uuid|escape:'html':'UTF-8'}" action="{$subcription_base_link|escape:'html':'UTF-8'}/{$subscription->uuid|escape:'html':'UTF-8'}/newdate" method="POST">
                    ...
                    <label class="form-label" for="next_billing-{$subscription->uuid|escape:'html':'UTF-8'}">{l s='New date:' mod='ciklik'}</label>
                    <input type="date" class="form-control" name="next_billing" id="next_billing-{$subscription->uuid|escape:'html':'UTF-8'}" min="{$next_billing_min|escape:'html':'UTF-8'}" max="{$next_billing_max|escape:'html':'UTF-8'}" required>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="newDateForm-{$subscription->uuid|escape:'html':'UTF-8'}" class="btn btn-primary">{l s='Update' mod='ciklik'}</button>
            </div>
